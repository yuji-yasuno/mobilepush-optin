//
//  AppDelegate.swift
//  mc taskforce mobile optin
//
//  Created by 楊野勇智 on 2016/01/15.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let etAppId = "Put your marketing cloud application id here"
    let etAccessToken = "Put your marketing cloud application access token here"
